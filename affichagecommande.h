...
namespace projetexia {
	...
	/// <summary>
	/// Description résumée de affichagecommande
	/// </summary>
	public ref class affichagecommande : public System::Windows::Forms::Form
	{
	public:
		affichagecommande(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &affichagecommande::button1_Click);
			// 
			// dgv
			// 
			...
			this->dgv->Name = L"dgv";
			this->dgv->Size = System::Drawing::Size(1496, 685);
			this->dgv->TabIndex = 95;
			// 
			// affichagecommande
			// 
			...
			this->Name = L"affichagecommande";
			this->Text = L"affichagecommande";
			this->Load += gcnew System::EventHandler(this, &affichagecommande::affichagecommande_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->dgv))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void affichagecommande_Load(System::Object^ sender, System::EventArgs^ e) {
