...
namespace projetexia {
	...
	/// <summary>
	/// Description résumée de articleplusvendu
	/// </summary>
	public ref class articleplusvendu : public System::Windows::Forms::Form
	{
	public:
		articleplusvendu(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(0, 702);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(1455, 48);
			this->button1->TabIndex = 164;
			this->button1->Text = L"Charger";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &articleplusvendu::button1_Click);
			// 
			// dgv
			// 
			...
			this->dgv->GridColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(48)), static_cast<System::Int32>(static_cast<System::Byte>(71)),
				static_cast<System::Int32>(static_cast<System::Byte>(94)));
			this->dgv->Location = System::Drawing::Point(0, -3);
			this->dgv->Name = L"dgv";
			this->dgv->Size = System::Drawing::Size(1455, 705);
			...
			this->Name = L"articleplusvendu";
			this->Text = L"articleplusvendu";
			this->WindowState = System::Windows::Forms::FormWindowState::Maximized;
			this->Load += gcnew System::EventHandler(this, &articleplusvendu::articleplusvendu_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->dgv))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void articleplusvendu_Load(System::Object^ sender, System::EventArgs^ e) {
		this->oSvP = gcnew NS_service_personnel::CLServicePersonnel();
	}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	this->dgv->Refresh();
	this->oDs = this->oSvP->articleplusvendu("Rsl");
